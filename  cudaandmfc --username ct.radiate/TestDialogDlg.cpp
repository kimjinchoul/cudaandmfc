...
{
	CDialog::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_STATIC_Result, m_stcResult);
	DDX_Control(pDX, IDC_STATIC_Display, m_wndDisplayer);
}
...
BEGIN_MESSAGE_MAP(CTestDialogDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDOK, &CTestDialogDlg::OnBnClickedOk)
	ON_WM_TIMER()
END_MESSAGE_MAP()


// CTestDialogDlg 消息处理程序
...
void CTestDialogDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	//OnOK();
...
void CTestDialogDlg::OnTimer(UINT_PTR nIDEvent)
{
